# Hexagonal_leds_matrix_WS2812B

Documentation and assets for the hexagonal LED matrix featuring 144 WS2812B-B/W LEDs.
[Product Page](https://www.tindie.com/products/foxlabs/triangle-leds-matrix-133mm-ws2812b-bw)

<img src="assets/hexagonal_leds_matrix_pic.jpg" alt="Hexagonal_leds_matrix" style="max-height: 400px;">
...
<img src="assets/hexagonal_leds_matrix_id_order_diagram.jpg" alt="Hexagonal_leds_matrix_ID_Diagram" style="max-height: 400px;">
...
- **Footprint:** DXF file for the PCB layout and screw holes. [assets/hexagonal_leds_matrix_WS2812B.DXF](./assets/hexagonal_leds_matrix_WS2812B.DXF)
- **3D Model:** STEP file for the LED matrix design. [assets/hexagonal_leds_matrix_WS2812B.STEP](./assets/hexagonal_leds_matrix_WS2812B.STEP)
